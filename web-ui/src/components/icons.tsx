...
export const HelpCircle = makeIcon(QuestionCircleIcon);
...
export const KeyRound = makeIcon(LockLockedIcon);
export const Link = makeIcon(LinkIcon);
export const Maximize = makeIcon(FullscreenEnterIcon);
export const Minimize = makeIcon(FullscreenExitIcon);
